...
void APhysicalAnimCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindTouch(IE_Pressed, this, &APhysicalAnimCharacter::TouchStarted);
	PlayerInputComponent->BindTouch(IE_Released, this, &APhysicalAnimCharacter::TouchStopped);
...
void APhysicalAnimCharacter::TouchStarted(ETouchIndex::Type FingerIndex, FVector Location)
{
		Jump();
}

void APhysicalAnimCharacter::TouchStopped(ETouchIndex::Type FingerIndex, FVector Location)
{
		StopJumping();
}
